...
\begin{frame}{Cryptosystems as commitment schemes}
  ...
  \begin{enumerate}[<+(1)->]
    ...
    \[
      ...
      \end{cases}
    \]
    \item $(c, m, r)$ is a valid decommitment if $c = \ENC_\PK(m; r)$.
  \end{enumerate}
\end{frame}

\begin{frame}{ElGamal as a commitment scheme}
  ElGamal encryption can be used as a commitment scheme.
  \begin{itemize}[<+(1)->]
...
\begin{frame}{Security assumptions}
  \pause
  The registration protocol must be trusted
  \begin{itemize}[<+(1)->]
...
\begin{frame}{Simulation}
  ...
  \begin{itemize}[<+(1)->]
    \item Transcript: all protocol messages exchanged between the prover and verifier
  \end{itemize}
\end{frame}
