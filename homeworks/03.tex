...
\begin{task}{ASiC-E containers}
  ...
  \begin{itemize}
    ...
    \item What eID \enquote{device} did I use to issue the signature?
...
\begin{task}{Propagating trust}
  ...
  Export your GPG public key from the previous task into a file in armored format and sign it with an Estonian digital signature (ID-card, Mobile-ID, Smart-ID, digi-ID, \dots) with DigiDoc.
...
\begin{task}{Are we the bad guys?}
  ...
  Include the file as \texttt{spurious.asice} in your repository.
